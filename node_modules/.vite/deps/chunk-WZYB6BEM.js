...
import {
  ...
  useMergedState,
  useToken
} from "./chunk-2LRHE76Y.js";
import {
  _classCallCheck,
  _createClass,
  _createSuper,
  _inherits
} from "./chunk-DYT75QZB.js";
import {
...
function SingleObserver(props, ref) {
  ...
  var mergedRef = React3.useMemo(function() {
...
var RefResizeObserver = React4.forwardRef(ResizeObserver);
if (true) {
...
function InternalItem(props, ref) {
  var prefixCls = props.prefixCls, invalidate = props.invalidate, item = props.item, renderItem = props.renderItem, responsive = props.responsive, responsiveDisabled = props.responsiveDisabled, registerSize = props.registerSize, itemKey = props.itemKey, className = props.className, style = props.style, children = props.children, display = props.display, order = props.order, _props$component = props.component, Component3 = _props$component === void 0 ? "div" : _props$component, restProps = _objectWithoutProperties(props, _excluded);
  ...
  var itemNode = React5.createElement(Component3, _extends({
  ...
  if (responsive) {
    itemNode = React5.createElement(es_default2, {
...
var Item = React5.forwardRef(InternalItem);
...
// node_modules/rc-overflow/es/hooks/useEffectState.js
function useBatcher() {
  var updateFuncRef = React6.useRef(null);
...
function useEffectState(notifyEffectUpdate, defaultValue) {
  var _React$useState = React6.useState(defaultValue), _React$useState2 = _slicedToArray(_React$useState, 2), stateValue = _React$useState2[0], setStateValue = _React$useState2[1];
...
var InternalRawItem = function InternalRawItem2(props, ref) {
  var context = React8.useContext(OverflowContext);
  if (!context) {
    var _props$component = props.component, Component3 = _props$component === void 0 ? "div" : _props$component, _restProps = _objectWithoutProperties(props, _excluded2);
    return React8.createElement(Component3, _extends({}, _restProps, {
      ref
    }));
  }
  ...
  return React8.createElement(OverflowContext.Provider, {
    value: null
  }, React8.createElement(Item_default, _extends({
    ref,
    className: (0, import_classnames2.default)(contextClassName, className)
  }, restContext, restProps)));
};
var RawItem = React8.forwardRef(InternalRawItem);
...
function Overflow(props, ref) {
  var _props$prefixCls = props.prefixCls, prefixCls = _props$prefixCls === void 0 ? "rc-overflow" : _props$prefixCls, _props$data = props.data, data = _props$data === void 0 ? [] : _props$data, renderItem = props.renderItem, renderRawItem = props.renderRawItem, itemKey = props.itemKey, _props$itemWidth = props.itemWidth, itemWidth = _props$itemWidth === void 0 ? 10 : _props$itemWidth, ssr = props.ssr, style = props.style, className = props.className, maxCount = props.maxCount, renderRest = props.renderRest, renderRawRest = props.renderRawRest, suffix = props.suffix, _props$component = props.component, Component3 = _props$component === void 0 ? "div" : _props$component, itemComponent = props.itemComponent, onVisibleChange = props.onVisibleChange, restProps = _objectWithoutProperties(props, _excluded4);
  ...
  var mergedDisplayCount = React9.useMemo(function() {
  ...
  var internalRenderItemNode = renderRawItem ? function(item, index) {
    ...
    var key = getKey(item, index);
    return React9.createElement(Item_default, _extends({}, itemSharedProps, {
      order: index,
      key,
      item,
  ...
  if (!renderRawRest) {
    ...
    restNode = React9.createElement(Item_default, _extends({}, itemSharedProps, restContextProps), typeof mergedRenderRest === "function" ? mergedRenderRest(omittedItems) : mergedRenderRest);
  } else if (renderRawRest) {
    restNode = React9.createElement(OverflowContext.Provider, {
      value: _objectSpread2(_objectSpread2({}, itemSharedProps), restContextProps)
    }, renderRawRest(omittedItems));
  }
  var overflowNode = React9.createElement(Component3, _extends({
    className: (0, import_classnames3.default)(!invalidate && prefixCls, className),
    style,
    ref
  }, restProps), mergedData.map(internalRenderItemNode), showRest ? restNode : null, suffix && React9.createElement(Item_default, _extends({}, itemSharedProps, {
  ...
  if (isResponsive) {
    overflowNode = React9.createElement(es_default2, {
...
var ForwardOverflow = React9.forwardRef(Overflow);
...
var IdContext = React10.createContext(null);
...
function useMenuId(eventKey) {
  var id = React10.useContext(IdContext);
...
var MenuContext = React11.createContext(null);
...
function InheritableContextProvider(_ref) {
  ...
  var context = React11.useContext(MenuContext);
  var inheritableContext = useMemo(function() {
    return mergeProps(context, restProps);
  }, [context, restProps], function(prev, next) {
    return !locked && (prev[0] !== next[0] || !isEqual_default(prev[1], next[1], true));
  });
  return React11.createElement(MenuContext.Provider, {
...
var EmptyList = [];
var PathRegisterContext = React12.createContext(null);
function useMeasure() {
  return React12.useContext(PathRegisterContext);
}
var PathTrackerContext = React12.createContext(EmptyList);
function useFullPath(eventKey) {
  var parentKeyPath = React12.useContext(PathTrackerContext);
  return React12.useMemo(function() {
    return eventKey !== void 0 ? [].concat(_toConsumableArray(parentKeyPath), [eventKey]) : parentKeyPath;
  }, [parentKeyPath, eventKey]);
}
var PathUserContext = React12.createContext(null);

// node_modules/rc-menu/es/context/PrivateContext.js
var React13 = __toESM(require_react());
var PrivateContext = React13.createContext({});
...
function useAccessibility(mode, activeKey, isRtl, id, containerRef, getKeys, getKeyPath, triggerActiveKey, triggerAccessibilityOpen, originOnKeyDown) {
  var rafRef = React14.useRef();
  var activeRef = React14.useRef();
...
function useKeyRecords() {
  var _React$useState = React15.useState({}), _React$useState2 = _slicedToArray(_React$useState, 2), internalForceUpdate = _React$useState2[1];
  var key2pathRef = (0, import_react3.useRef)(/* @__PURE__ */ new Map());
  var path2keyRef = (0, import_react3.useRef)(/* @__PURE__ */ new Map());
  var _React$useState3 = React15.useState([]), _React$useState4 = _slicedToArray(_React$useState3, 2), overflowKeys = _React$useState4[0], setOverflowKeys = _React$useState4[1];
...
function useMemoCallback(func) {
  var funRef = React16.useRef(func);
  funRef.current = func;
  var callback = React16.useCallback(function() {
    var _funRef$current;
...
function useActive(eventKey, disabled, onMouseEnter, onMouseLeave) {
  var _React$useContext = React18.useContext(MenuContext), activeKey = _React$useContext.activeKey, onActive = _React$useContext.onActive, onInactive = _React$useContext.onInactive;
  var ret = {
...
function useDirectionStyle(level) {
  var _React$useContext = React19.useContext(MenuContext), mode = _React$useContext.mode, rtl = _React$useContext.rtl, inlineIndent = _React$useContext.inlineIndent;
  if (mode !== "inline") {
    return null;
  }
  var len = level;
...
function Icon(_ref) {
  ...
  if (typeof icon === "function") {
    iconNode = React20.createElement(icon, _objectSpread2({}, props));
...
var LegacyMenuItem = function(_React$Component) {
  ...
  _createClass(LegacyMenuItem2, [{
    ...
    value: function render() {
      ...
      return React21.createElement(es_default3.Item, _extends({}, attribute, {
...
var InternalMenuItem = React21.forwardRef(function(props, ref) {
  var _classNames;
...
function MenuItem(props, ref) {
  ...
  return React21.createElement(InternalMenuItem, _extends({}, props, {
    ref
  }));
}
var MenuItem_default = React21.forwardRef(MenuItem);
...
var InternalSubMenuList = function InternalSubMenuList2(_ref, ref) {
  ...
  var _React$useContext = React22.useContext(MenuContext), prefixCls = _React$useContext.prefixCls, mode = _React$useContext.mode, rtl = _React$useContext.rtl;
  return React22.createElement("ul", _extends({
...
var SubMenuList = React22.forwardRef(InternalSubMenuList);
...
function parseChildren(children, keyPath) {
  return toArray(children).map(function(child, index) {
    if (React23.isValidElement(child)) {
      ...
      return React23.cloneElement(child, cloneProps);
    }
    return child;
  });
}
...
var OrderContext = React24.createContext(null);
...
function useDom(render, debug) {
  ...
  var appendedRef = React25.useRef(false);
  var queueCreate = React25.useContext(Context_default);
  var _React$useState3 = React25.useState(EMPTY_LIST), _React$useState4 = _slicedToArray(_React$useState3, 2), queue = _React$useState4[0], setQueue = _React$useState4[1];
...
var Portal = React27.forwardRef(function(props, ref) {
  ...
  var _React$useState = React27.useState(open), _React$useState2 = _slicedToArray(_React$useState, 2), shouldRender = _React$useState2[0], setShouldRender = _React$useState2[1];
  ...
  var _React$useState3 = React27.useState(function() {
  ...
  if (ref) {
    reffedChildren = React27.cloneElement(children, {
      ref: mergedRef
    });
  }
...
function getUseId() {
  var fullClone = _objectSpread2({}, React28);
  return fullClone.useId;
}
var uuid2 = 0;
function useId(id) {
  var _React$useState = React28.useState("ssr-id"), _React$useState2 = _slicedToArray(_React$useState, 2), innerId = _React$useState2[0], setInnerId = _React$useState2[1];
...
var TriggerContext = React29.createContext(null);
...
function useAlign(open, popupEle, target, placement, builtinPlacements, popupAlign, onPopupAlign) {
  ...
  var alignCountRef = React31.useRef(0);
  var scrollerList = React31.useMemo(function() {
    if (!popupEle) {
      return [];
    }
    return collectScroller(popupEle);
  }, [popupEle]);
  var prevFlipRef = React31.useRef({});
...
function useWinClick(open, clickToHide, targetEle, popupEle, mask, maskClosable, inPopupOrChild, triggerOpen) {
  var openRef = React32.useRef(open);
  var lockRef = React32.useRef(false);
...
function Mask(props) {
  ...
  return React34.createElement(es_default, _extends({}, motion, {
    motionAppear: true,
    visible: open,
    removeOnLeave: true
  }), function(_ref) {
...
var PopupContent = React35.memo(function(_ref) {
...
// node_modules/@rc-component/trigger/es/Popup/index.js
var Popup = React36.forwardRef(function(props, ref) {
  ...
  var _React$useState = React36.useState(!getPopupContainer || !getPopupContainerNeedParams), _React$useState2 = _slicedToArray(_React$useState, 2), show = _React$useState2[0], setShow = _React$useState2[1];
  useLayoutEffect_default(function() {
  ...
  return React36.createElement(Portal2, {
    open: forceRender || isNodeVisible,
    getContainer: getPopupContainer && function() {
      return getPopupContainer(target);
    },
    autoDestroy
  }, React36.createElement(Mask, {
    prefixCls,
    open,
    zIndex,
    mask,
    motion: maskMotion
  }), React36.createElement(es_default2, {
    onResize: onAlign,
    disabled: !open
  }, function(resizeObserverRef) {
    return React36.createElement(es_default, _extends({
      motionAppear: true,
      motionEnter: true,
      motionLeave: true,
      removeOnLeave: false,
      ...
      return React36.createElement("div", {
        ...
        onPointerEnter,
        onClick
      }, arrow && React36.createElement(Arrow, {
        prefixCls,
        arrow,
        arrowPos,
        align
      }), React36.createElement(PopupContent_default, {
        cache: !open && !fresh
      }, childNode));
    });
  }));
...
var TriggerWrapper = React37.forwardRef(function(props, ref) {
  var children = props.children, getTriggerDOMNode = props.getTriggerDOMNode;
  var canUseRef = supportRef(children);
  var setRef = React37.useCallback(function(node) {
    fillRef(ref, getTriggerDOMNode ? getTriggerDOMNode(node) : node);
  }, [getTriggerDOMNode]);
  var mergedRef = useComposeRef(setRef, children.ref);
  return canUseRef ? React37.cloneElement(children, {
    ref: mergedRef
  }) : children;
});
if (true) {
...
// node_modules/@rc-component/trigger/es/index.js
var _excluded9 = ["prefixCls", "children", "action", "showAction", "hideAction", "popupVisible", "defaultPopupVisible", "onPopupVisibleChange", "afterPopupVisibleChange", "mouseEnterDelay", "mouseLeaveDelay", "focusDelay", "blurDelay", "mask", "maskClosable", "getPopupContainer", "forceRender", "autoDestroy", "destroyPopupOnHide", "popup", "popupClassName", "popupStyle", "popupPlacement", "builtinPlacements", "popupAlign", "zIndex", "stretch", "getPopupClassNameFromAlign", "fresh", "alignPoint", "onPopupClick", "onPopupAlign", "arrow", "popupMotion", "maskMotion", "popupTransitionName", "popupAnimation", "maskTransitionName", "maskAnimation", "className", "getTriggerDOMNode"];
...
function PopupTrigger(_ref) {
  ...
  var targetMotionRef = React39.useRef(targetMotion);
  if (mode !== "inline") {
  ...
  return React39.createElement(es_default5, {
    prefixCls,
...
function InlineSubMenuList(_ref) {
  ...
  var _React$useContext = React40.useContext(MenuContext), prefixCls = _React$useContext.prefixCls, forceSubMenuRender = _React$useContext.forceSubMenuRender, motion = _React$useContext.motion, defaultMotions = _React$useContext.defaultMotions, mode = _React$useContext.mode;
  var sameModeRef = React40.useRef(false);
  sameModeRef.current = mode === fixedMode;
  var _React$useState = React40.useState(!sameModeRef.current), _React$useState2 = _slicedToArray(_React$useState, 2), destroy = _React$useState2[0], setDestroy = _React$useState2[1];
  ...
  return React40.createElement(InheritableContextProvider, {
    mode: fixedMode,
    locked: !sameModeRef.current
  }, React40.createElement(es_default, _extends({
    visible: mergedOpen
  }, mergedMotion, {
    forceRender: forceSubMenuRender,
    removeOnLeave: false,
    ...
    return React40.createElement(SubMenuList_default, {
      id,
...
// node_modules/rc-menu/es/SubMenu/index.js
var _excluded10 = ["style", "className", "title", "eventKey", "warnKey", "disabled", "internalPopupClose", "children", "itemIcon", "expandIcon", "popupClassName", "popupOffset", "popupStyle", "onClick", "onMouseEnter", "onMouseLeave", "onTitleClick", "onTitleMouseEnter", "onTitleMouseLeave"];
...
var InternalSubMenu = function InternalSubMenu2(props) {
  ...
  var domDataId = useMenuId(eventKey);
  var _React$useContext = React41.useContext(MenuContext), prefixCls = _React$useContext.prefixCls, mode = _React$useContext.mode, openKeys = _React$useContext.openKeys, contextDisabled = _React$useContext.disabled, overflowDisabled = _React$useContext.overflowDisabled, activeKey = _React$useContext.activeKey, selectedKeys = _React$useContext.selectedKeys, contextItemIcon = _React$useContext.itemIcon, contextExpandIcon = _React$useContext.expandIcon, onItemClick = _React$useContext.onItemClick, onOpenChange = _React$useContext.onOpenChange, onActive = _React$useContext.onActive;
  var _React$useContext2 = React41.useContext(PrivateContext_default), _internalRenderSubMenuItem = _React$useContext2._internalRenderSubMenuItem;
  var _React$useContext3 = React41.useContext(PathUserContext), isSubPathKey = _React$useContext3.isSubPathKey;
  var connectedPath = useFullPath();
  var subMenuPrefixCls = "".concat(prefixCls, "-submenu");
  var mergedDisabled = contextDisabled || disabled;
  var elementRef = React41.useRef();
  var popupRef = React41.useRef();
  if (warnKey) {
  ...
  var _React$useState = React41.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), childrenActive = _React$useState2[0], setChildrenActive = _React$useState2[1];
  ...
  var mergedActive = React41.useMemo(function() {
    if (active) {
      return active;
    }
    if (mode !== "inline") {
  ...
  var titleNode = React41.createElement("div", _extends({
    role: "menuitem",
    ...
    onFocus: onInternalFocus
  }, activeProps), title, React41.createElement(Icon, {
  ...
  }, React41.createElement("i", {
    className: "".concat(subMenuPrefixCls, "-arrow")
  })));
  var triggerModeRef = React41.useRef(mode);
  ...
  if (!overflowDisabled) {
    ...
    titleNode = React41.createElement(PopupTrigger, {
      mode: triggerMode,
      ...
      popupOffset,
      popupStyle,
      popup: React41.createElement(
        InheritableContextProvider,
        {
          mode: triggerMode === "horizontal" ? "vertical" : triggerMode
        },
        React41.createElement(SubMenuList_default, {
          id: popupId,
          ref: popupRef
        }, children)
      ),
  ...
  var listNode = React41.createElement(es_default3.Item, _extends({
    role: "none"
  }, restProps, {
    component: "li",
    style,
  ...
  }), titleNode, !overflowDisabled && React41.createElement(InlineSubMenuList, {
    id: popupId,
    open,
  ...
  return React41.createElement(InheritableContextProvider, {
...
function SubMenu(props) {
  ...
  if (measure) {
    ...
    renderNode = React41.createElement(InternalSubMenu, props, childList);
  }
  return React41.createElement(PathTrackerContext.Provider, {
...
var _excluded11 = ["className", "title", "eventKey", "children"];
var _excluded25 = ["children"];
var InternalMenuItemGroup = function InternalMenuItemGroup2(_ref) {
  var className = _ref.className, title = _ref.title, eventKey = _ref.eventKey, children = _ref.children, restProps = _objectWithoutProperties(_ref, _excluded11);
  var _React$useContext = React42.useContext(MenuContext), prefixCls = _React$useContext.prefixCls;
  var groupPrefixCls = "".concat(prefixCls, "-item-group");
  return React42.createElement("li", _extends({
    role: "presentation"
  }, restProps, {
    onClick: function onClick(e) {
      return e.stopPropagation();
    },
    className: (0, import_classnames12.default)(groupPrefixCls, className)
  }), React42.createElement("div", {
    role: "presentation",
    className: "".concat(groupPrefixCls, "-title"),
    title: typeof title === "string" ? title : void 0
  }, title), React42.createElement("ul", {
    role: "group",
...
function MenuItemGroup(_ref2) {
  ...
  return React42.createElement(InternalMenuItemGroup, omit(props, ["warnKey"]), childList);
}
...
function Divider(_ref) {
  ...
  return React43.createElement("li", {
    role: "separator",
...
// node_modules/rc-menu/es/utils/nodeUtil.js
var _excluded12 = ["label", "children", "key", "type"];
function convertItemsToNodes(list) {
  return (list || []).map(function(opt, index) {
    if (opt && _typeof(opt) === "object") {
      var _ref = opt, label = _ref.label, children = _ref.children, key = _ref.key, type = _ref.type, restProps = _objectWithoutProperties(_ref, _excluded12);
...
var EMPTY_LIST2 = [];
var Menu = React45.forwardRef(function(props, ref) {
  ...
  var childList = React45.useMemo(function() {
    return parseItems(children, items, EMPTY_LIST2);
  }, [children, items]);
  var _React$useState = React45.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), mounted = _React$useState2[0], setMounted = _React$useState2[1];
  var containerRef = React45.useRef();
  ...
  var _React$useState3 = React45.useState(mergedOpenKeys), _React$useState4 = _slicedToArray(_React$useState3, 2), inlineCacheOpenKeys = _React$useState4[0], setInlineCacheOpenKeys = _React$useState4[1];
  var mountRef = React45.useRef(false);
  ...
  var _React$useState5 = React45.useState(mergedMode), _React$useState6 = _slicedToArray(_React$useState5, 2), internalMode = _React$useState6[0], setInternalMode = _React$useState6[1];
  var _React$useState7 = React45.useState(mergedInlineCollapsed), _React$useState8 = _slicedToArray(_React$useState7, 2), internalInlineCollapsed = _React$useState8[0], setInternalInlineCollapsed = _React$useState8[1];
  ...
  var _React$useState9 = React45.useState(0), _React$useState10 = _slicedToArray(_React$useState9, 2), lastVisibleIndex = _React$useState10[0], setLastVisibleIndex = _React$useState10[1];
  ...
  var registerPathContext = React45.useMemo(function() {
    return {
      registerPath,
      unregisterPath
    };
  }, [registerPath, unregisterPath]);
  var pathUserContext = React45.useMemo(function() {
    return {
      isSubPathKey
    };
  }, [isSubPathKey]);
  ...
  var privateContext = React45.useMemo(function() {
    return {
  ...
  var wrappedChildList = internalMode !== "horizontal" || disabledOverflow ? childList : (
    ...
    childList.map(function(child, index) {
      return (
        ...
        React45.createElement(InheritableContextProvider, {
          key: child.key,
  ...
  var container = React45.createElement(es_default3, _extends({
    id,
    ref: containerRef,
    prefixCls: "".concat(prefixCls, "-overflow"),
    component: "ul",
    itemComponent: MenuItem_default,
    className: (0, import_classnames14.default)(prefixCls, "".concat(prefixCls, "-root"), "".concat(prefixCls, "-").concat(internalMode), className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-inline-collapsed"), internalInlineCollapsed), _defineProperty(_classNames, "".concat(prefixCls, "-rtl"), isRtl), _classNames), rootClassName),
    dir: direction,
    style,
    role: "menu",
    tabIndex,
    ...
    renderRawRest: function renderRawRest(omitItems) {
      ...
      return React45.createElement(SubMenu, {
  ...
  return React45.createElement(PrivateContext_default.Provider, {
    value: privateContext
  }, React45.createElement(IdContext.Provider, {
    value: uuid3
  }, React45.createElement(InheritableContextProvider, {
    prefixCls,
    rootClassName,
  ...
  }, React45.createElement(PathUserContext.Provider, {
    value: pathUserContext
  }, container), React45.createElement("div", {
    style: {
      display: "none"
    },
    "aria-hidden": true
  }, React45.createElement(PathRegisterContext.Provider, {
...
var LayoutContext = React46.createContext({
  siderHook: {
    addSider: () => null,
    removeSider: () => null
  }
...
function generator(_ref) {
  ...
  return (BasicComponent) => {
    const Adapter = React46.forwardRef((props, ref) => React46.createElement(BasicComponent, Object.assign({
      ref,
      suffixCls,
      tagName
    }, props)));
...
var Basic = React46.forwardRef((props, ref) => {
  const {
  ...
  return wrapSSR(React46.createElement(TagName, Object.assign({
    className: (0, import_classnames15.default)(customizePrefixCls || prefixWithSuffixCls, className, hashId),
    ref
  }, others)));
});
var BasicLayout = React46.forwardRef((props, ref) => {
  const {
    direction
  } = React46.useContext(ConfigContext);
  const [siders, setSiders] = React46.useState([]);
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
  ...
  const prefixCls = getPrefixCls("layout", customizePrefixCls);
  const [wrapSSR, hashId] = style_default(prefixCls);
  const classString = (0, import_classnames15.default)(prefixCls, {
  ...
  return wrapSSR(React46.createElement(LayoutContext.Provider, {
    value: contextValue
  }, React46.createElement(Tag, Object.assign({
    ref,
...
var SiderContext = React47.createContext({});
var generateId = (() => {
  let i = 0;
  return function() {
...
var Sider = React47.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    className,
    trigger,
  ...
  const {
    siderHook
  } = (0, import_react5.useContext)(LayoutContext);
  const [collapsed, setCollapsed] = (0, import_react5.useState)("collapsed" in props ? props.collapsed : defaultCollapsed);
  const [below, setBelow] = (0, import_react5.useState)(false);
  ...
  const responsiveHandlerRef = (0, import_react5.useRef)();
  ...
  const renderSider = () => {
    ...
    const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React47.createElement("span", {
      onClick: toggle,
    ...
    }, trigger || React47.createElement(BarsOutlined_default, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React47.createElement(RightOutlined_default, null) : React47.createElement(LeftOutlined_default, null),
      collapsed: reverseArrow ? React47.createElement(LeftOutlined_default, null) : React47.createElement(RightOutlined_default, null)
    };
    const status = collapsed ? "collapsed" : "expanded";
    const defaultTrigger = iconObj[status];
    const triggerDom = trigger !== null ? zeroWidthTrigger || React47.createElement("div", {
    ...
    return React47.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return React47.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider());
});
if (true) {
...
// node_modules/rc-tooltip/es/Tooltip.js
var _excluded14 = ["overlayClassName", "trigger", "mouseEnterDelay", "mouseLeaveDelay", "overlayStyle", "prefixCls", "children", "onVisibleChange", "afterVisibleChange", "transitionName", "animation", "motion", "placement", "align", "destroyTooltipOnHide", "defaultVisible", "getTooltipContainer", "overlayInnerStyle", "arrowContent", "overlay", "id", "showArrow"];
var Tooltip = function Tooltip2(props, ref) {
  ...
  var getPopupElement = function getPopupElement2() {
    return React49.createElement(Popup2, {
      key: "content",
      prefixCls,
      id,
      overlayInnerStyle
  ...
  return React49.createElement(es_default5, _extends({
...
function parseColor(prefixCls, color) {
  ...
  const className = (0, import_classnames18.default)({
...
var PurePanel = (props) => {
  ...
  const cls = (0, import_classnames19.default)(hashId, prefixCls, `${prefixCls}-pure`, `${prefixCls}-placement-${placement}`, className, colorInfo.className);
  return wrapSSR(React50.createElement("div", {
    className: cls,
    style: arrowContentStyle
  }, React50.createElement("div", {
    className: `${prefixCls}-arrow`
  }), React50.createElement(Popup2, Object.assign({}, props, {
    className: hashId,
    prefixCls,
...
var Tooltip3 = React51.forwardRef((props, ref) => {
  var _a, _b;
  const {
    prefixCls: customizePrefixCls,
    openClassName,
  ...
  const tooltipPlacements = React51.useMemo(() => {
    var _a2, _b2;
  ...
  const memoOverlay = React51.useMemo(() => {
    if (title === 0) {
      return title;
    }
    return overlay || title || "";
  }, [overlay, title]);
  const memoOverlayWrapper = React51.createElement(NoCompactStyle, null, typeof memoOverlay === "function" ? memoOverlay() : memoOverlay);
  const {
    getPopupContainer,
    placement = "top",
    mouseEnterDelay = 0.1,
  ...
  const child = isValidElement(children) && !isFragment(children) ? children : React51.createElement("span", null, children);
  const childProps = child.props;
  const childCls = !childProps.className || typeof childProps.className === "string" ? (0, import_classnames20.default)(childProps.className, openClassName || `${prefixCls}-open`) : childProps.className;
  const [wrapSSR, hashId] = style_default2(prefixCls, !injectFromPopover);
  const colorInfo = parseColor(prefixCls, color);
  const arrowContentStyle = colorInfo.arrowStyle;
  const formattedOverlayInnerStyle = Object.assign(Object.assign({}, overlayInnerStyle), colorInfo.overlayStyle);
  const customOverlayClassName = (0, import_classnames20.default)(overlayClassName, {
    [`${prefixCls}-rtl`]: direction === "rtl"
  }, colorInfo.className, rootClassName, hashId);
  return wrapSSR(React51.createElement(es_default7, Object.assign({}, otherProps, {
    ...
    overlayInnerStyle: formattedOverlayInnerStyle,
    arrowContent: React51.createElement("span", {
...
var MenuContext2 = (0, import_react7.createContext)({
  prefixCls: "",
  firstLevel: true,
...
var MenuItem2 = (props) => {
  ...
  } = React52.useContext(MenuContext_default);
  const renderItemChildren = (inlineCollapsed) => {
    const wrapNode = React52.createElement("span", {
  ...
  const {
    siderCollapsed
  } = React52.useContext(SiderContext);
  ...
  let returnNode = React52.createElement(MenuItem_default, Object.assign({}, omit(props, ["title", "icon", "danger"]), {
    ...
    className: (0, import_classnames21.default)(isValidElement(icon) ? (_a = icon.props) === null || _a === void 0 ? void 0 : _a.className : "", `${prefixCls}-item-icon`)
  }), renderItemChildren(isInlineCollapsed));
  if (!disableMenuItemTitleTooltip) {
    returnNode = React52.createElement(tooltip_default, Object.assign({}, tooltipProps, {
...
//# sourceMappingURL=chunk-WZYB6BEM.js.map
