...
function memoResult(callback, deps) {
  ...
  for (var i = 0; i < deps.length - 1; i += 1) {
    var dep = deps[i];
    if (!current.has(dep)) {
  ...
  var lastDep = deps[deps.length - 1];
...
function useCacheToken(theme, tokens) {
  ...
  var _useContext = (0, import_react2.useContext)(StyleContext_default), instanceId = _useContext.cache.instanceId;
  ...
  var mergedToken = tokens.length ? memoResult(function() {
...
var LocaleProvider = (props) => {
  ...
  const getMemoizedContextValue = React12.useMemo(() => Object.assign(Object.assign({}, locale4), {
    exist: true
  }), [locale4]);
...
var ProviderChildren = (props) => {
  ...
  if (memoedConfig.warning) {
    childNode = React29.createElement(WarningContext.Provider, {
...
var SpaceCompactItemContext = React31.createContext(null);
var useCompactItemContext = (prefixCls, direction) => {
  const compactItemContext = React31.useContext(SpaceCompactItemContext);
  const compactItemClassnames = React31.useMemo(() => {
...
var NoCompactStyle = (_ref) => {
  ...
  return React31.createElement(SpaceCompactItemContext.Provider, {
    value: null
  }, children);
};
var CompactItem = (_a) => {
...
var Compact = (props) => {
  ...
  const nodes = React31.useMemo(() => childNodes.map((child, i) => {
    const key = child && child.key || `${prefixCls}-item-${i}`;
    return React31.createElement(CompactItem, {
      key,
  ...
  return wrapSSR(React31.createElement("div", Object.assign({
    className: clx
  }, restProps), nodes));
};
...
//# sourceMappingURL=chunk-2LRHE76Y.js.map
